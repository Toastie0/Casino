...
public class StickyDiceCubeItem extends Item {
    ...
    private static final DispenserBehavior DISPENSER_BEHAVIOR = new ItemDispenserBehavior() {
        ...
        public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
            ...
            double g = 0.1f;
            StickyDiceCubeEntity diceCubeEntity = new StickyDiceCubeEntity(serverWorld,d, e + g, f);
            diceCubeEntity.setVelocity(
                    shoot(direction, 0.15f + MathHelper.cos((float) e), 0.75f + MathHelper.sin((float) e))
            );
            diceCubeEntity.setDiceType(stack.isOf(RefineRegistry.SLIME_DICE));
    ...
    public StickyDiceCubeItem(boolean type, Settings settings) {
        super(settings);
        this.type = type;
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if(user.getStackInHand(hand).getItem() instanceof StickyDiceCubeItem)
        {
            ...
            StickyDiceCubeEntity diceCubeEntity = new StickyDiceCubeEntity (world,spawnPos.getX(),spawnPos.getY(),spawnPos.getZ());
            ...
            diceCubeEntity.setDiceType(this.type);
